...
**4 примера состояний, в которых может находиться репозиторий**<br>
...
*$ git log --oneline*<br>
Хеш коммита снова поменялся, потому что изменились сообщение и время коммита. При этом файлы в коммите остались те же.<br>
